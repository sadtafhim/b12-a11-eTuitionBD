      ...
      <div className="absolute inset-0 z-10">
        <div className="h-full max-w-7xl mx-auto flex items-center px-4 md:px-6">
          <div className="flex flex-col gap-6 w-full lg:w-2/3 text-white">
            <h1 className="text-5xl lg:text-6xl font-extrabold leading-tight text-primary-content capitalize">
              <Fade cascade damping={0.1}>
                <p>Find your perfect tutor at your fingertips.</p>
              </Fade>
            </h1>

            <p className="text-lg text-secondary-content opacity-90">
              <Typewriter
                words={[
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 text-sm font-medium">
              <div className="flex items-center gap-2 text-secondary-content opacity-90">
                <FaRegCheckCircle className="text-accent text-xl" />
                Find Your Tutor
              </div>
              <div className="flex items-center gap-2 text-secondary-content opacity-90">
                <FaRegCheckCircle className="text-accent text-xl" />
