            ...
            {user ? (
              <div className="flex items-center gap-3">
                ...
                <div className="dropdown dropdown-end">
                  ...
                  <ul
                    tabIndex={0}
                    className="menu menu-sm dropdown-content mt-3 p-2 shadow bg-linear-to-r from-primary to-secondary/80 rounded-box w-52 border border-base-300"
                  >
                    <li className="px-4 py-2 font-bold text-base-100 border-b border-base-200 mb-2">
                      {user.displayName}
                    </li>
                    <li>
              ...
              <NavLink
                to="/auth/login"
                className="btn border-0 bg-linear-to-r from-accent to-primary text-white px-6 rounded-full hover:scale-105 transition-transform flex items-center gap-2"
              >
